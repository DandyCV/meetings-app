...
ActiveRecord::Schema[8.1].define(version: 2026_08_31_191744) do
  ...
  create_table "meetings", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.text "description"
    t.integer "meeting_attachments_count", default: 0, null: false
  ...
  add_foreign_key "meeting_attachments", "meetings"
